local config = {
	...
	["hero"] = {count = 200, storage = 1022, start = 1, plural = "heroes"},
	...
	["behemoth"] = {count = 3000, storage = 1027, start = 1, plural = "behemoth"},
	...
	["warlock"] = {count = 300, storage = 1032, start = 1, plural = "warlocks"},
...
function onKill(player, target)
	...
	if storageValue >= monster.start then
		if storageValue >= monster.count then
			player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE, "You have already killed " .. monster.count .. " " .. monster.plural .. ". Report back to Grizzly Adams in Thais.")
		else
